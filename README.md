...
PROJECT OVERVIEW
--The Bus Reservation System is a simple Java application developed using JDBC and MySQL. This application allows users to enter passenger details such as Passenger Name, Bus Number, and Date of Birth. The entered details are stored in a MySQL database using JDBC connectivity.
